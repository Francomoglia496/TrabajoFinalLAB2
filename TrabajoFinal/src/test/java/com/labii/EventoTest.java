...
public class EventoTest extends TestCase {
    ...
    public void testEvento() throws Exception{
        ...
        Evento evento1 = new Evento(0,"Evento1", 0, "lalala",
                new Fecha(3, 12, 2016, 1,56), new Fecha(4,12,2016,1,57),"rojo");
        Evento evento2 = new Evento(1,"Evento2", 0, "lalala",
                new Fecha(3, 12, 2016, 1,56), new Fecha(5,12,2016,1,57),"azul");
        Evento evento3 = new Evento(2,"Evento3", 1, "lalala",
                new Fecha(3, 12, 2016, 1,56), new Fecha(4,12,2017,1,57),"verde");
